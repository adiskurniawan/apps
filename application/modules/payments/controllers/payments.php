...
class Payments extends Admin_Controller {
    ...
    public function form($id = NULL)
    {
        ...
        $open_invoices = $this->mdl_invoices->where('invoice_amounts.invoice_balance >', 0)->get()->result();
        ...
        if ($id)
        {
            $this->layout->set('payment', $this->mdl_payments->where('payments.payment_id', $id)->get()->row());
        }
