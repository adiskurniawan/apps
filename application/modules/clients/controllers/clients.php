...
class Clients extends Admin_Controller {
    ...
    public function status($status = 'active', $page = 0)
    {
        ...
        $this->layout->buffer('main_content', 'clients/partial_client_table');
        $this->layout->render('layout_invoicing');
    }
    ...
    public function view($client_id)
    {
        ...
        $client = $this->mdl_clients->with_total()->with_total_balance()->with_total_paid()->where('clients.client_id', $client_id)->get()->row();
