<?php
class Item_m extends Response_Model
{
	
	public $table               = 'items';
    public $primary_key         = 'items.item_id';
    public $date_created_field  = 'item_date_created';
    public $date_modified_field = 'item_date_modified';
