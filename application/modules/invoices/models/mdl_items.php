...
class Mdl_Items extends Response_Model {
    ...
    public $primary_key        = 'invoice_items.item_id';
    public $date_created_field  = 'item_date_added';
    
    public function default_select()
    {
        $this->db->select('invoice_item_amounts.*, invoice_items.*, item_tax_rates.tax_rate_percent AS item_tax_rate_percent');
    }
    ...
    {
        $this->db->join('invoice_item_amounts', 'invoice_item_amounts.item_id = invoice_items.item_id', 'left');
        $this->db->join('tax_rates AS item_tax_rates', 'item_tax_rates.tax_rate_id = invoice_items.item_tax_rate_id', 'left');
    }
    ...
    public function delete($item_id)
    {
        ...
        $invoice_id = $this->db->get('invoice_items')->row()->invoice_id;
