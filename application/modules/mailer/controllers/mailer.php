...
class Mailer extends Admin_Controller {
    ...
    public function invoice($invoice_id)
    {
        if ($this->mailer_configured == TRUE)
        {
            ...
            $this->layout->set('invoice', $this->mdl_invoices->where('invoices.invoice_id', $invoice_id)->get()->row());
    ...
    public function quote($quote_id)
    {
        if ($this->mailer_configured == TRUE)
        {
            ...
            $this->layout->set('quote', $this->mdl_quotes->where('quotes.quote_id', $quote_id)->get()->row());
